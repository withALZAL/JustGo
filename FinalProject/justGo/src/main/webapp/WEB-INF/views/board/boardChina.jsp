...
<div class="template--pageTitleContainer">
    <div class="template--pageTitleBox">
        <img src="/images/officialPageTitle/PAGETITLE_CHINA_FOBBIDDENCITY.png" alt="중국_자금성">
        <div class="template--overlayedTitle" style="color: black;">
            <img src="/images/officialFlag/CHINAFLAG.png" alt="중국국기" style="height: 30px; padding-right: 10px;">
            <a href="https://www.naver.com">
                중국게시판
            </a>
        </div>
