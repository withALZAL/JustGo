...
<div class="template--pageTitleContainer">
    <div class="template--pageTitleBox">
        <img src="/images/officialPageTitle/PAGETITLE_THAI_CASTLE.png" alt="태국_왕궁">
        <div class="template--overlayedTitle" style="color: black;">
            <img src="/images/officialFlag/THAIFLAG.png" alt="태국국기" style="height: 30px; padding-right: 10px;">
            <a href="https://www.naver.com">
                태국게시판
            </a>
        </div>
