...
<!-- css -->
    ...
    <title>JustGo-boardAustralia</title>
...
<div class="template--pageTitleContainer">
    <div class="template--pageTitleBox">
        <img src="/images/officialPageTitle/PAGETITLE_AUSTRALIA_OCEAN.png" alt="호주_그레이프베리어리프">
        <div class="template--overlayedTitle" style="color: black;">
            <img src="/images/officialFlag/AUSTRALIAFLAG.png" alt="호주국기" style="height: 30px; padding-right: 10px;">
            <a href="https://www.naver.com">
                호주게시판
            </a>
        </div>
