...
<!-- css -->
    ...
    <title>JustGo-boardVietnam</title>
...
<div class="template--pageTitleContainer">
    <div class="template--pageTitleBox">
        <img src="/images/officialPageTitle/PAGETITLE_VIETNAM_HALONGBAY.png" alt="베트남_하롱베이">
        <div class="template--overlayedTitle" style="color: black;">
            <img src="/images/officialFlag/VIETNAMFLAG.png" alt="베트남국기" style="height: 30px; padding-right: 10px;">
            <a href="https://www.naver.com">
                베트남게시판
            </a>
        </div>
