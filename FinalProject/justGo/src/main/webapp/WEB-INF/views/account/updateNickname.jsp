...
<!-- css -->
    ...
    <title>JustGo-updateNickname</title>
...
<div class="template--pageTitleContainer">
    <div class="template--pageTitleBox">
        ...
        <div class="template--overlayedTitle">닉네임 수정</div>
    </div>
</div>
<!-- 페이지 제목 끝 -->
...
<div class="account--joinContainer">
    <div class="account--joinBox">
        <form action="updateNickname" method="post" id=updateInfo>
...
<!-- js -->
    ...
    <script src="/resources/js/account/updateNickname.js"></script>
</body>
</html>
