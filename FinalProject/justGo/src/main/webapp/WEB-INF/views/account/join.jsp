        ...
        <form action="https://www.naver.com" method="post">
            <div class="account--inputProfileBox">
                <a href="https://www.google.com">
                    <img src="/images/officialProfile/COMMONPROFILE.png" alt="프로필 이미지" style="border: 3px solid black;">
                    <!-- <input type="file"> -->
                </a>
            </div>
...
<!--                             <div style="height: 5px; font-size: 0.2rem; color: red;">사용할 수 없는 이메일입니다.</div> -->
                        </td>
                        <td><button type="button" class="btn btn-secondary btn-sm">인증</button></td>
                    </tr>
                    <tr>
                        <th>인증번호</th>
                        <td>
                            <input type="text" placeholder="이메일로 발송된 인증번호를 입력해주세요.">
<!--                             <div style="height: 5px; font-size: 0.2rem; color: green;">인증되었습니다.</div> -->
                        ...
                        <td><button type="button" class="btn btn-secondary btn-sm">확인</button></td>
                    </tr>
                    <tr>
                        <th>비밀번호</th>
                        <td>
