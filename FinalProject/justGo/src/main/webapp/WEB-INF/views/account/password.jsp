...
<div class="template--pageTitleContainer">
    <div class="template--pageTitleBox">
        ...
        <div class="template--overlayedTitle">비밀번호 찾기</div>
    </div>
</div>
<!-- 페이지 제목 끝 -->
...
<div class="account--joinContainer">
    <div class="account--joinBox">
        <form action="/account/password" method="post" id="passwordFrm">
...
<!-- js -->
    ...
    <script src="/resources/js/account/password.js"></script>
</body>
</html>